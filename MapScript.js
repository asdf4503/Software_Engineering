...
document.addEventListener("DOMContentLoaded", function() {
    var skyviewButton = document.getElementById("Skyview_button");
    var trafficButton = document.getElementById("traffic_button");
  
    skyviewButton.addEventListener("click", function() {
      skyviewButton.classList.toggle("active");
    });
